...
class AudinceListUserModal {
  ...
  int valueRank = 0;
  String myroom = "";
  late String takeSeatRequst;
  late String agent;
  AudinceListUserModal(
    this.email,
    this.name,
    this.gender,
    this.photo,
  ...
  factory AudinceListUserModal.fromJson(Map<String, dynamic> json) {
    return AudinceListUserModal(
      json['email'],
      json['name'],
      json['gender'],
      json['photo'],
