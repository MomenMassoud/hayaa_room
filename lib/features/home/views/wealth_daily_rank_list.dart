...
class WealthDailyRankList extends StatefulWidget {
  WealthDailyRankList({super.key});
  List<RankUserModel> rankUsers = [];
  @override
  State<WealthDailyRankList> createState() => _WealthDailyRankListState();
}

class _WealthDailyRankListState extends State<WealthDailyRankList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: _firestore
            .collection("user")
            .orderBy("welthday", descending: true)
            .limit(10)
            .snapshots(),
                      ...
                      children: [
                        Padding(
                          ...
                          child: TopCard(
                              ...
                              rankCoinValue: widget.rankUsers[1].welthDay),
                        ),
                        ...
                        TopCard(
                            ...
                            rankCoinValue: widget.rankUsers[0].welthDay),
                        const SizedBox(width: 6),
                        Padding(
                          padding: const EdgeInsets.only(top: 45),
                          child: TopCard(
                              ...
                              rankCoinValue: widget.rankUsers[2].welthDay),
                        ),
                      ],
                    ),
                  ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return UserRankCard(
                              ...
                              rankCoinValue:
                                  widget.rankUsers[index + 3].welthDay,
                              rankCoinImage: AppImages.goldCoin,
                              levelImage:
                                  "lib/core/Utils/assets/images/wealth&charm badges/wealth126-150.png");
                        },
