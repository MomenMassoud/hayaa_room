...
class WealthMonthlyRankList extends StatefulWidget {
  WealthMonthlyRankList({super.key});
  List<RankUserModel> rankUsers = [];
  @override
  State<WealthMonthlyRankList> createState() => _WealthMonthlyRankListState();
}

class _WealthMonthlyRankListState extends State<WealthMonthlyRankList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: _firestore
            .collection("user")
            .orderBy("welthmonth", descending: true)
            .limit(10)
            .snapshots(),
                      ...
                      children: [
                        Padding(
                          ...
                          child: TopCard(
                              ...
                              rankCoinValue: widget.rankUsers[1].welthMonth),
                        ),
                        ...
                        TopCard(
                            ...
                            rankCoinValue: widget.rankUsers[0].welthMonth),
                        const SizedBox(width: 6),
                        Padding(
                          padding: const EdgeInsets.only(top: 45),
                          child: TopCard(
                              ...
                              rankCoinValue: widget.rankUsers[2].welthMonth),
                        ),
                      ],
                    ),
                  ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return UserRankCard(
                              ...
                              rankCoinValue:
                                  widget.rankUsers[index + 3].welthMonth,
                              rankCoinImage: AppImages.goldCoin,
                              levelImage:
                                  "lib/core/Utils/assets/images/wealth&charm badges/wealth126-150.png");
                        },
