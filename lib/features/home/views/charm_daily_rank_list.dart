...
import 'package:hayaa_main/features/home/widgets/user_rank_card.dart';

import '../../../core/Utils/app_images.dart';
import '../models/rank_user_model.dart';
import '../widgets/top_card.dart';

class CharmDailyRankList extends StatefulWidget {
  CharmDailyRankList({super.key});
  List<RankUserModel> rankUsers = [];
  @override
  State<CharmDailyRankList> createState() => _CharmDailyRankListState();
}

class _CharmDailyRankListState extends State<CharmDailyRankList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: _firestore
            .collection("user")
            .orderBy("charmday", descending: true)
            .limit(10)
            .snapshots(),
                      ...
                      children: [
                        Padding(
                          ...
                          child: TopCard(
                              ...
                              rankCoinValue: widget.rankUsers[1].charmDay),
                        ),
                        ...
                        TopCard(
                            ...
                            rankCoinValue: widget.rankUsers[0].charmDay),
                        const SizedBox(width: 6),
                        Padding(
                          padding: const EdgeInsets.only(top: 45),
                          child: TopCard(
                              ...
                              rankCoinValue: widget.rankUsers[2].charmDay),
                        ),
                      ],
                    ),
                  ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return UserRankCard(
                              ...
                              rankCoinValue:
                                  widget.rankUsers[index + 3].charmDay,
                              rankCoinImage: AppImages.daimond,
                              levelImage:
                                  "lib/core/Utils/assets/images/wealth&charm badges/charm 126-150.png");
                        },
