...
class CharmWeaklyRankList extends StatefulWidget {
  CharmWeaklyRankList({super.key});
  List<RankUserModel> rankUsers = [];
  @override
  State<CharmWeaklyRankList> createState() => _CharmWeaklyRankListState();
}

class _CharmWeaklyRankListState extends State<CharmWeaklyRankList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder(
          stream: _firestore
              .collection("user")
              .orderBy("charmweak", descending: true)
              .limit(10)
              .snapshots(),
                        ...
                        children: [
                          Padding(
                            ...
                            child: TopCard(
                                ...
                                rankCoinValue: widget.rankUsers[1].charmWeak),
                          ),
                          ...
                          TopCard(
                              ...
                              rankCoinValue: widget.rankUsers[0].charmWeak),
                          const SizedBox(width: 6),
                          Padding(
                            padding: const EdgeInsets.only(top: 45),
                            child: TopCard(
                                ...
                                rankCoinValue: widget.rankUsers[2].charmWeak),
                          ),
                        ],
                      ),
                    ),
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return UserRankCard(
                                ...
                                rankCoinValue:
                                    widget.rankUsers[index + 3].charmWeak,
                                rankCoinImage: AppImages.daimond,
                                levelImage:
                                    "lib/core/Utils/assets/images/wealth&charm badges/charm 126-150.png");
                          },
