                    ...
                    children: [
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          shape:
                              BoxShape.circle, // Clip the container to a circle
                        ),
                        child: Stack(
                          children: [
                            Image.asset(int.parse(userModel.level) >= 1 &&
                                    int.parse(userModel.level) < 20
                                ? AppImages.wealth1to19Main
                                : int.parse(userModel.level) >= 20 &&
                                        int.parse(userModel.level) < 40
                                    ? AppImages.wealth20to39Main
                                    : int.parse(userModel.level) >= 40 &&
                                            int.parse(userModel.level) < 50
                                        ? AppImages.wealth40to49Main
                                        : int.parse(userModel.level) >= 50 &&
                                                int.parse(userModel.level) < 60
                                            ? AppImages.wealth50to59Main
                                            : int.parse(userModel.level) >= 60 &&
                                                    int.parse(userModel.level) <
                                                        70
                                                ? AppImages.wealth60to69Main
                                                : int.parse(userModel.level) >= 70 &&
                                                        int.parse(userModel.level) <
                                                            80
                                                    ? AppImages.wealth70to79Main
                                                    : int.parse(userModel.level) >= 80 &&
                                                            int.parse(userModel.level) <
                                                                90
                                                        ? AppImages
                                                            .wealth80to89Main
                                                        : int.parse(userModel.level) >=
                                                            ...
                                                            : int.parse(userModel.level) >=
                                                                        100 &&
                                                                    int.parse(userModel.level) < 126
                                                                ? AppImages.wealth100to125Main
